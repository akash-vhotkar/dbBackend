                    ...
                    if (err) throw err
                        ...
                        wallet.findOne({ 'id': sid }, (err, data1) => {
                            if (err) throw err
                                ...
                                wallet.updateOne({ 'id': id }, {
                                    $inc: {
                                        'walletBal': +300, 'directIncome': +300, 'levelIncome': +300,
                                        'currentBal': +300, 'totalearning': +300, 'lastBal': last
                                    }
                                }, (err) => {
                                    if (err) throw err
                                    else {
                                        let ins = new statement({
                                            'name': name, 'mobile': mobile, 'id': sid, 'tranT': 'Credit',
                    ...
                    if (err) throw err
                        ...
                        wallet.findOne({ 'id': sid }, (err, data1) => {
                            if (err) throw err
                                ...
                                wallet.updateOne({ 'id': id }, {
                                    $inc: {
                                        'walletBal': +65, 'levelIncome': +65,
                                        'currentBal': +65, 'totalearning': +65, 'lastBal': last
                                    }
                                }, (err) => {
                                    if (err) throw err
                                    else {
                    ...
                    if (err) throw err
                        ...
                        wallet.findOne({ 'id': sid }, (err, data1) => {
                            if (err) throw err
                                ...
                                wallet.updateOne({ 'id': id }, {
                                    $inc: {
                                        'walletBal': +50, 'totalearning': +50, 'levelIncome': +50,
                                        'currentBal': +50, 'lastBal': last
                                    }
                                }, (err) => {
                                    if (err) throw err
                                    else {
                    ...
                    if (err) throw err
                        ...
                        wallet.findOne({ 'id': sid }, (err, data1) => {
                            if (err) throw err
                                ...
                                wallet.updateOne({ 'id': id }, {
                                    $inc: {
                                        'walletBal': +40, 'totalearning': +40, 'levelIncome': +40,
                                        'currentBal': +40, 'lastBal': last
                                    }
                                }, (err) => {
                                    if (err) throw err
                                    else {
                    ...
                    if (err) throw err
                        ...
                        wallet.findOne({ 'id': sid }, (err, data1) => {
                            if (err) throw err
                                ...
                                wallet.updateOne({ 'id': id }, {
                                    $inc: {
                                        'walletBal': +30, 'totalearning': +30, 'levelIncome': +30,
                                        'currentBal': +30, 'lastBal': last
                                    }
                                }, (err) => {
                                    if (err) throw err
                                    else {
                    ...
                    if (err) throw err
                        ...
                        wallet.findOne({ 'id': sid }, (err, data1) => {
                            if (err) throw err
                                ...
                                wallet.updateOne({ 'id': id }, {
                                    $inc: {
                                        'walletBal': +25, 'totalearning': +25, 'levelIncome': +25,
                                        'currentBal': +25, 'lastBal': last
                                    }
                                }, (err) => {
                                    if (err) throw err
                                    else {
                    ...
                    if (err) throw err
                        ...
                        wallet.findOne({ 'id': sid }, (err, data1) => {
                            if (err) throw err
                                ...
                                wallet.updateOne({ 'id': id }, {
                                    $inc: {
                                        'walletBal': +20, 'totalearning': +20, 'levelIncome': +20,
                                        'currentBal': +20, 'lastBal': last
                                    }
                                }, (err) => {
                                    if (err) throw err
                                    else {
                    ...
                    if (err) throw err
                        ...
                        wallet.findOne({ 'id': sid }, (err, data1) => {
                            if (err) throw err
                                ...
                                wallet.updateOne({ 'id': id }, {
                                    $inc: {
                                        'walletBal': +15, 'totalearning': +15, 'levelIncome': +15,
                                        'currentBal': +15, 'lastBal': last
                                    }
                                }, (err) => {
                                    if (err) throw err
                                    else {
                    ...
                    if (err) throw err
                        ...
                        wallet.findOne({ 'id': sid }, (err, data1) => {
                            if (err) throw err
                                ...
                                wallet.updateOne({ 'id': id }, {
                                    $inc: {
                                        'walletBal': +10, 'totalearning': +10, 'levelIncome': +10,
                                        'currentBal': +10, 'lastBal': last
                                    }
                                }, (err) => {
                                    if (err) throw err
                                    else {
